...
import kotlinx.android.synthetic.main.fragment_questao_3.*
...
class Questao3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_questao_3, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*buttonAvancar.setClickListener{
            ...
            findNavController().navigate(R.id.questao4Fragment)
        }*/
    }

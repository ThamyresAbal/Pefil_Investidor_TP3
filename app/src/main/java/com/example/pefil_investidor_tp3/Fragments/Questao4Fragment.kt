...
import kotlinx.android.synthetic.main.fragment_questao_4.*
...
class Questao4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_questao_4, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*buttonAvancar.setClickListener{
            ...
            findNavController().navigate(R.id.questao5Fragment)
        }*/
    }

...
import kotlinx.android.synthetic.main.fragment_questao_5.*
...
class Questao5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_questao_5, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*buttonAvancar.setClickListener{
            ...
            findNavController().navigate(R.id.questao6Fragment)
        }*/
    }
